...
tab1, tab2, tab3, tab4 = st.tabs(["Data science", "Data engineering", "Poésie", "Autres"])
with tab1:
    ...
    with tab2:
        with st.expander("Designing Machine learning systems an iterative process for production"):
            col1, col2 = st.columns(2, gap="small", vertical_alignment="center")
            with col1:
                st.image("./assets/DMSD.jpg", use_column_width="auto")
